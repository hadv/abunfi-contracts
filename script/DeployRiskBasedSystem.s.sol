...
contract DeployRiskBasedSystem is Script {
    ...
    function _deployStrategies() internal {
        ...
        liquidStakingStrategy = address(
            new LiquidStakingStrategy(
                usdc,
                mockStakingToken,
                address(0), // Vault address will be set later
    ...
    function _deployVault() internal {
        ...
        // Deploy AbunfiVault
        vault = address(new AbunfiVault(usdc, trustedForwarder, riskProfileManager, withdrawalManager));
    ...
    function _setupRiskAllocations() internal {
        ...
        sm.setRiskLevelAllocation(RiskProfileManager.RiskLevel.LOW, lowRiskStrategies, lowRiskAllocations);
        ...
        sm.setRiskLevelAllocation(RiskProfileManager.RiskLevel.MEDIUM, mediumRiskStrategies, mediumRiskAllocations);
        ...
        sm.setRiskLevelAllocation(RiskProfileManager.RiskLevel.HIGH, highRiskStrategies, highRiskAllocations);
