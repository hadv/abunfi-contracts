...
contract MockAaveDataProvider {
        ...
        returns (address aTokenAddress, address stableDebtTokenAddress, address variableDebtTokenAddress)
    {
        ...
        return (tokens.aTokenAddress, tokens.stableDebtTokenAddress, tokens.variableDebtTokenAddress);
    }
     ...
     */
    function getAllReservesTokens() external pure returns (address[] memory, string[] memory) {
     ...
     * @dev Get all aTokens
     */
    function getAllATokens() external pure returns (address[] memory, string[] memory) {
        // Mock implementation - return empty arrays
        address[] memory addresses = new address[](0);
        string[] memory symbols = new string[](0);
        return (addresses, symbols);
