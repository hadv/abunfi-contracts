...
contract PaymasterVaultIntegrationTest is Test {
    ...
    function test_VaultIntegration_ShowsRealWorldUsage() public {
        ...
        testUsers[0] = premiumUser;
        testAmounts[0] = smallAmount;
        testGasLimits[0] = 200000;
        testGasPrices[0] = 20 gwei;
        shouldSponsor[0] = true;
        testUsers[1] = premiumUser;
        testAmounts[1] = largeAmount;
        testGasLimits[1] = 400000;
        testGasPrices[1] = 50 gwei;
        shouldSponsor[1] = true;
        testUsers[2] = basicUser;
        testAmounts[2] = smallAmount;
        testGasLimits[2] = 200000;
        testGasPrices[2] = 20 gwei;
        shouldSponsor[2] = true;
        testUsers[3] = basicUser;
        testAmounts[3] = mediumAmount;
        testGasLimits[3] = 300000;
        testGasPrices[3] = 40 gwei;
        shouldSponsor[3] = false;
        testUsers[4] = restrictedUser;
        testAmounts[4] = smallAmount;
        testGasLimits[4] = 200000;
        testGasPrices[4] = 20 gwei;
        shouldSponsor[4] = false;
        testUsers[5] = whitelistedUser;
        testAmounts[5] = largeAmount;
        testGasLimits[5] = 500000;
        testGasPrices[5] = 60 gwei;
        shouldSponsor[5] = true;
