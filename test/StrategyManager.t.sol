...
contract StrategyManagerTest is Test {
    ...
    function test_StrategyManagement_AddNewStrategy() public {
        ...
        (IAbunfiStrategy strategy, uint256 weight, uint256 riskScore, uint256 maxAllocation, uint256 minAllocation, bool isActive, uint256 lastAPY, uint256 apyHistory, uint256 performanceScore) = strategyManager.strategies(address(mockAaveStrategy));
    ...
    // Fuzz Tests
    function testFuzz_AddStrategy_ValidParameters(uint256 weight, uint256 riskScore, uint256 maxAlloc, uint256 minAlloc) public {
        ...
        (, uint256 stratWeight, uint256 stratRisk,,, bool isActive,,,) = strategyManager.strategies(address(mockAaveStrategy));
