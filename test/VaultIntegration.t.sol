...
contract VaultIntegrationTest is Test {
    ...
    function setUp() public {
        ...
        mockAaveDataProvider.setReserveTokens(
            address(mockUSDC),
            address(mockAUSDC),
            address(0),
            address(0)
    ...
    function test_StrategyManagement_GetAllStrategiesInfo() public {
        ...
        (address[] memory addresses, string[] memory names, uint256[] memory totalAssetsAmounts, uint256[] memory apys, uint256[] memory weights) = vault.getAllStrategiesInfo();
    ...
    function test_StrategyManagement_UpdateStrategyWeights() public {
        ...
        (, uint256 totalAssetsAmount, uint256 apy, uint256 weight, bool isActive) = vault.getStrategyInfo(address(aaveStrategy));
        assertEq(weight, 70);
    }
